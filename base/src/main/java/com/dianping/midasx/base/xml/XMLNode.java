...
import com.dianping.midasx.base.xml.core.IXMLNodeSet;
...
public class XMLNode extends Table<String, String> implements IXMLNode, Cloneable {
    ...
    public String toString()
    {
        ...
        for(ILink<String, String> property : this) {
            sb.append(" ");
            sb.append(property.origin());
            sb.append("=\"");
            sb.append(xmlTextToString(property.destination()));
            sb.append("\"");
        }
        if(0 == children.size()) {
            if(null == value) {
...
//			}
    ...
    public Object clone() {
        ...
        // 更新属性
        for(ILink<String, String> property : this) {
            result.put(property.origin(), property.destination());
        }
        // 更新子节点
