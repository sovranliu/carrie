package com.dianping.midasx.lightning.access;

import com.dianping.midasx.lightning.Lightning;
...
public class ServletFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        if(!Lightning.initialize(filterConfig.getServletContext().getRealPath("/WEB-INF"))) {
